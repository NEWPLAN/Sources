...
int main()
{
    clock_t start=clock();
    unsigned int i = 0;
    char haystack[] /*= "ushers ushers 22221";
    ...
    dlrekfas;dl;lfk;eejg;efj;daslew;qkfsad;wewlkfdsfdle;wwwwwwwwwwwwwwdlfk;ewlfkdssf'welfkd;fkasdl;wkfdsald;wgkfdsjgfdsafk\
    ja;kfd;wfela;kfew;lfk;ewfk;leakf'safe'kwnewplankdsa;'d;flrfas;dlwfk;leakf'safe'kwpfkdlfkdsa;'d;flrekfas;dlle;wwwwwwwww\
    ...
    char needle[][255]= {"he","wwwwwwwwwwwwww", "wdlfk","hers","newplan"};
